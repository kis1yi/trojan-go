...
type UserStatus struct {
	...
	// Per-user quota in bytes; <0 means unlimited, >0 enforces a hard cap.
	// Marked `optional` so callers can distinguish "leave existing value as
	// is" (field absent) from "explicitly set to 0" (field present, value 0)
	// — proto3 zero values are otherwise indistinguishable from "unset".
...
func (x *UserStatus) GetQuota() int64 {
...
const file_api_proto_rawDesc = "" +
	...
	"\x04hash\x18\x02 \x01(\tR\x04hash\"\xb7\x02\n" +
	"\n" +
	"UserStatus\x12$\n" +
	...
	"\bip_limit\x18\x06 \x01(\x05R\aipLimit\x12\x19\n" +
	"\x05quota\x18\a \x01(\x03H\x00R\x05quota\x88\x01\x01B\b\n" +
	"\x06_quota\"9\n" +
	...
	"\apayload\x18\b \x01(\fR\apayload2d\n" +
	"\x13TrojanClientService\x12M\n" +
	"\n" +
	"GetTraffic\x12\x1d.trojan.api.GetTrafficRequest\x1a\x1e.trojan.api.GetTrafficResponse\"\x002\xce\x02\n" +
	...
	"\n" +
	"GetRecords\x12\x1d.trojan.api.GetRecordsRequest\x1a\x1e.trojan.api.GetRecordsResponse\"\x000\x01B)Z'github.com/kis1yi/trojan-go/api/serviceb\x06proto3"
